...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-400 via-gray-600 to-slate-900 flex items-center justify-center text-white">
      <div className="bg-white text-gray-800 p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSignUp} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-br from-slate-400 via-gray-600 to-slate-600 text-white py-3 rounded-md hover:bg-blue-700 transition-colors font-semibold"
          >
            Sign Up
          </button>
        </form>
